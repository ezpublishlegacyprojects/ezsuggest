...
<script type="text/javascript">
<!--
	var dsProducts = new Spry.Data.XMLDataSet({"/layout/set/ezsuggest/ezsuggest/search"|ezurl} , "/results/result");
//-->
</script>
...
{/section}
    ...
    {literal}
	<div id="search_result" spry:region="dsProducts">
		<table>
			<tr spry:repeat="dsProducts" spry:suggest="{word}">
				<td class="search_word">{word}</td>
				<td class="search_nb_results">{count}</td>
			</tr>
		</table>
	</div>
	
	<script type="text/javascript">
		var as7 = new Spry.Widget.AutoSuggest("search", "search_result", "dsProducts", 'word', {loadFromServer: true, minCharsType:1, urlParam: 'keyword'});
	</script>
	{/literal}
...
<!--
	...
	if(strChMid.indexOf("MSIE 7") != -1) {
		//IE7 hack to display the search div result
		window.scrollBy(0, 2);
	}
-->
</script>
